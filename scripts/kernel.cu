...
const CONSTANT_MEM ftype KNOTS[7] = {0.4, 0.5, 1.0, 1.5, 2.0, 3.0, 12.};
...
WITHIN_KERNEL
ftype get_omega(const ftype eta, const ftype tag, const ftype p0,
                const ftype p1, const ftype p2, const ftype dp0,
                const ftype dp1, const ftype dp2, const ftype eta_bar) {
  ftype omega = 0;
